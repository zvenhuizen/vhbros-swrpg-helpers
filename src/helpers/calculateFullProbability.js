...
export function rollProbabilities(myArray) {
    ...
    if(undefined !== myArray && myArray.length) {
        ...
        finalArray = Array(374).fill(0); //initialize 374 element array with 0s
        ...
        for (var i = 0; i < myArray.length; i++) {
            ...
            for(var answer = 0; answer < netRoll.length; answer++) {

                if(result.toString() === netRoll[answer].toString()) {
                    finalArray[answer] += 1;
                }
            }
        }
    }
    /*After all iterations, I am left with a finalArray of 374 elements. Each element will be the number of
