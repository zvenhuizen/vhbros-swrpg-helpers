...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // Add state of diceInputValue set to an empty string
      // Add state of rolledDice set to an empty string
    }
    // Bind handleDiceInputChange to this
    // Bind handleRollDiceClick to this
  }
